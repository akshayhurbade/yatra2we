           ...
           steps {
              script {
                withCredentials([usernameColonPassword(credentialsId: 'admin1', variable: 'admin')]) {
                 sh 'docker login http://54.172.79.88:8081/repository/yatra-2 -u admin1 -p ${admin}'
                 echo "Push Docker Image to Nexus : In Progress"
                 sh 'docker tag yatra2we 154.172.79.88:8081/yatra2we:latest'
                 sh 'docker push 54.172.79.88:8081/yatra2we'
