           ...
           steps {
              script {
                withCredentials([usernamePassword(credentialsId: 'nexuscred', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                 sh 'docker login http://18.207.128.21:8082/repository/yatra-2 -u admin -p ${PASSWORD}'
                 echo "Push Docker Image to Nexus : In Progress"
                 echo "Push Docker Image to Nexus : In Progress"
                 sh 'docker tag yatra2we 18.207.128.21:8082/yatra2we:latest'
                 sh 'docker push 18.207.128.21:8082/yatra2we'
